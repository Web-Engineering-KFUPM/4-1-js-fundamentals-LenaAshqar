...
console.log("2" + 3);
console.log(2 + "3");
// the first two concatenate because one of the operands is a string so it assumes the other one is a string
...
//       Use if–else statements to categorize and log:
//         - "Child" if age < 13
...
if (age > 35) { console.log("Aged"); }
else if (age > 13) { console.log("Young"); }
